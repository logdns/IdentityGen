...
async function handleRequest(request) {
  ...
  <html>
  <head>
    <title>美国真实地址和姓名生成工具-格式(姓名,性别,电话,真实地址,地图)</title>
  ...
  <body>
    <div class="title">美国真实地址和姓名生成工具-格式(姓名,性别,电话,真实地址,地图)</div>
    <div class="container">
      ...
      <button class="refresh-btn" onclick="window.location.reload();">生成新的地址</button>
    ...
    <div class="footer">
      © # All rights reserved | <a href="https://github.com/chatgptuk/Real-US-Address-Generator" target="_blank">GitHub code</a>
    </div>
    <script>
